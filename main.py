...
if user_input:
    try:
        ...
        if response_message.get('function_call'):
            ...
            # if function_name in ['get_stock_price', 'calculate_MSI', 'calculate_MACD', 'plot_stock_price']:
            #     args_dict = {
            #         'ticker': function_args.get('ticker')
            #     }

            # elif function_name in ['calculate_SMA', 'calculate_EMA']:
            #     args_dict = {'ticker': function_args.get('ticker'), 'window':
            #                  function_args.get('window')}
